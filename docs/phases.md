...
## Phase 17 — Build a Simple GPT from Scratch (nanoGPT)

Standalone learning exercise — separate from the .NET project. Implement a minimal GPT transformer in Python following Andrej Karpathy's nanoGPT (github.com/karpathy/nanoGPT).
